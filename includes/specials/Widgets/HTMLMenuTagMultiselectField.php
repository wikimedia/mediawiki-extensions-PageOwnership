...
include_once __DIR__ . '/MenuTagMultiselectWidget.php';
 ...
 */
class HTMLMenuTagMultiselectField extends HTMLTextField {
	...
	public function getInputOOUI( $value ) {
		...
		if ( isset( $this->mParams['options'] ) ) {
			...
			if ( !isset( $params['allowArbitrary'] ) || $params['allowArbitrary'] === false ) {
				$params['allowedValues'] = array_values( $params['options'] );
			}
		}
		...
		$widget = new MenuTagMultiselectWidget( $params );
	...
	protected function getOOUIModules() {
		return [ 'ext.PageOwnership.MenuTagMultiselectWidget' ];
	}
